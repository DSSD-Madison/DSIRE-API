...
export const stateID = new GraphQLEnumType({
    name: "StateId",
    description:
        "A US state or territory via its two-letter postal abbreviation.",
...
export const state = new GraphQLObjectType({
    ...
    fields: {
        id: {
            type: new GraphQLNonNull(stateID),
            description:
                "The state or territory's two-letter postal abbreviation."
        },
        name: {
            type: new GraphQLNonNull(GraphQLString),
            description: "The state or territory's name."
        }
    }
});
*/
